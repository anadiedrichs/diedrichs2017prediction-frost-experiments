...
#' y se desfasaron los datos a un día, es decir, contamos sólo con variables del día anterior para predecir
...
#' 
aux <- desfasar.dataset.t1(sensores, pred_sensores)
...
#' 
save(res, file = paste("hc-dacc-spring-t1-",Sys.time(),".RData",sep=""))
